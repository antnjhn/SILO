...
Download **`SILO_0.2.3_x64-setup.exe`** (the release's only asset) from the [Releases](https://github.com/antnjhn/SILO/releases/latest) page and run it.

| File | Type |
|------|------|
| `SILO_0.2.3_x64-setup.exe` | NSIS installer |
